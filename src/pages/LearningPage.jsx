...
// ── Official vendor & certifying-body resources ──────────────────────────────
// Policy: link only to the official vendor academies and certifying bodies.
// No third-party training marketplaces (Udemy, Coursera, CBT Nuggets, INE,
// etc.) — those are direct competitors of the Sabr Learning product.
const resources = [
  {
    name: 'Check Point Mind',
    desc: 'Official Check Point training, courseware, and certifications (CCSA, CCSE, CCSM).',
    href: 'https://training-certifications.checkpoint.com',
    tag: 'Check Point',
    tagColor: 'text-violet-400 bg-violet-400/10 border-violet-400/25',
  },
  {
    name: 'CompTIA',
    desc: 'Official CompTIA certification resources, CertMaster study tools, and exam vouchers for Security+, Network+, CySA+, A+, and more.',
  ...
  },
  {
    ...
    desc: 'Official Cisco study materials, community forums, and practice exams for CCNA, CCNP, CCIE, and specialist tracks.',
    href: 'https://learningnetwork.cisco.com',
    tag: 'Cisco',
    tagColor: 'text-cyan-400 bg-cyan-400/10 border-cyan-400/25',
  },
  {
    name: 'Palo Alto Networks Beacon',
    desc: 'Official Palo Alto training portal for PCNSA, PCNSE, and the broader Cortex / Prisma certification catalogue.',
  ...
  },
  {
    ...
    desc: 'Official Fortinet Network Security Expert curriculum — NSE 1 through NSE 8, plus FortiGate and FortiAnalyzer labs.',
    href: 'https://training.fortinet.com',
    tag: 'Fortinet',
    tagColor: 'text-rose-400 bg-rose-400/10 border-rose-400/25',
  },
  {
    name: 'Juniper Learning Portal',
    desc: 'Official Juniper Networks certification tracks (JNCIA, JNCIS, JNCIP, JNCIE) for service provider, enterprise, and security.',
    href: 'https://learningportal.juniper.net',
    tag: 'Juniper',
    tagColor: 'text-teal-400 bg-teal-400/10 border-teal-400/25',
  },
  {
    name: 'HPE Learn',
    desc: 'Official Hewlett Packard Enterprise training and Aruba certifications (ACA, ACP, ACE) for campus and data-center networking.',
    href: 'https://learn.hpe.com',
    tag: 'HPE / Aruba',
    tagColor: 'text-green-400 bg-green-400/10 border-green-400/25',
  },
  {
    name: 'Microsoft Learn',
    desc: 'Official Microsoft training for Azure (AZ-104, AZ-500), Microsoft 365, and Security, Compliance, and Identity (SC-900, SC-200) certifications.',
  ...
  },
  {
    ...
    desc: 'Official Amazon Web Services training hub covering the AWS Certified Solutions Architect, Developer, Security, and Specialty tracks.',
  ...
  },
  {
    ...
    desc: "Official Google Cloud learning platform for the Associate Cloud Engineer and Professional Cloud Architect certifications.",
